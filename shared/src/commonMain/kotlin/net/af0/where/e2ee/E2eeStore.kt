...
class E2eeStore(
    ...
    suspend fun processScannedQr(
        ...
        stateLock.withLock {
            ...
            if (pendingInvites.values.any { it.qrPayload.ekPub.contentEquals(qr.ekPub) }) {
     ...
     * @param discoveryTokenHex The discovery token used to receive this payload.
    ...
    suspend fun processKeyExchangeInit(
        ...
        stateLock.withLock {
            val pending = pendingInvites[discoveryTokenHex] ?: return@withLock null
            val msg =
