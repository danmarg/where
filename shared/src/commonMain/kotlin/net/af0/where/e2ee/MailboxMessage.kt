 ...
 *
 * The ciphertext decrypts to: nextSendToken (16 bytes) || padded location JSON.
 * The nextSendToken embedded in the ciphertext is the token the recipient should
 * poll for the NEXT message — structurally enforcing the single-token invariant (§7.4.1).
 *
