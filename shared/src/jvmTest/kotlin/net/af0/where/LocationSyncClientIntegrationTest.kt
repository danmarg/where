...
class LocationSyncClientIntegrationTest {
    ...
    @Test
    fun connectAndReceivesBroadcastOnLocationUpdate() =
        runBlocking {
    ...
    @Test
    fun sendLocationRemoveResultsInEmptyBroadcast() =
        runBlocking {
            val received = Channel<List<UserLocation>>(capacity = Channel.UNLIMITED)
            val client =
                LocationSyncClient(
    ...
    @Test
    fun disconnectStopsReceivingUpdates() =
        runBlocking {
            val received = Channel<List<UserLocation>>(capacity = Channel.UNLIMITED)
            val client =
                LocationSyncClient(
